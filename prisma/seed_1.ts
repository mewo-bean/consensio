...
async function main() {
    ...
    const pssQuestions = [
        ...
        "Как часто за последний месяц Вам не удавалось справляться с повседневными проблемами?",
        "Как часто за последний месяц Вы чувствовали, что не справляетесь с изменениями?",
        "Как часто за последний месяц Вы не чувствовали уверенности в способности решать личные проблемы?",
        "Как часто за последний месяц Вы замечали, что дела идут не так, как Вы хотели?",
        "Как часто за последний месяц Вы чувствовали, что не в силах справиться со всеми делами?",
        "Как часто за последний месяц Вы не могли контролировать раздражение?",
        "Как часто за последний месяц Вы чувствовали, что далеки от успеха?",
        ...
        "Как часто за последний месяц Вы не могли контролировать, как проводите время?",
    ...
    const gallupQuestions = [
        ...
        "За последнюю неделю со мной говорили о прогрессе.",
        "За последние две недели была возможность расти."
    ];
